...
import type { ControllerOptions, TTSBoundaryUpdate } from './controller.cjs';
/**
 ...
 */
type TTSBoundaryHandler = (boundary: TTSBoundaryUpdate, evt: SpeechSynthesisEvent | Event) => void;
