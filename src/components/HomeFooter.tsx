  ...
  return (
    <div className='py-8 px-16 '>
      <div className='flex items-center justify-between'>
        ...
        <span>
            <img src={facebook} alt="facebookLogo cursor-pointer" />
        </span>
        <span>
            <img src={insta} alt="instaLogo cursor-pointer" />
        </span>
        <span>
            <img src={twitter} alt="twitterLogo cursor-pointer" />
        </span>
        </div>
      ...
      <div className='flex justify-between items-center'>
        ...
        <div className=' flex justify-between items-center '>
            ...
            <span className='ml-4 cursor-pointer'><AppleStore/> </span>
