...
const FormWrapper = ({children}:Props) => {
  return (
    <div className="py-20 px-14 bg-white relative h-screen w-[100%]">
        ...
        <img src={RoundYellow} alt="Ellipse" className='absolute top-20 right-60' />
        ...
        <img src={RoundGreen} alt="Ellipse" className='absolute bottom-4 left-96' />
        <img src={Star} alt="Ellipse" className='absolute bottom-16 left-32' />
        <img src={SixGreen} alt="Ellipse" className='absolute bottom-96 left-16' />
