...
import MomthPackage from "@/pages/KundaKidsUnlimited2/MonthPackage";
import YearPackage from "@/pages/KundaKidsUnlimited2/YearPackage";
    ...
    <>
      <ParentSignupLayout active={2}>
        <div className="mt-20 relative">
          ...
          {isMonth ? <MomthPackage /> : <YearPackage />}
        </div>
      </ParentSignupLayout>
    </>
  );
