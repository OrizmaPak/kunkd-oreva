...
import {
  ...
  SelectAvatar,
  WellDoneModal,
} from "@/pages/AfterParentSignIn/Modals";
import { STEP_1, STEP_2, STEP_3, STEP_4 } from "@/utils/constants";
import { useState } from "react";
import LessDownIcon from "@/assets/lessthanIcon.svg";
import { motion } from "framer-motion";

// import ChildAgeModal from "@/pages/AfterParentSignIn/Modals";
// import SelectAvatar from "@/pages/AfterParentSignIn/Modals";
// import ChildNameModal from "@/pages/AfterParentSignIn/Modals";
  ...
  return (
    <>
      ...
      >
        ...
        >
          {currentStep === STEP_1 && (
            <ChildNameModal onContinue={() => setCurrentStep(STEP_2)} />
          )}
          {currentStep === STEP_2 && (
            <ChildAgeModal onContinue={() => setCurrentStep(STEP_3)} />
          )}
          {currentStep === STEP_3 && (
            <SelectAvatar onContinue={() => setCurrentStep(STEP_4)} />
          )}
          {currentStep === STEP_4 && (
            <WellDoneModal
              onContinue={() => {
