...
const SubscriptionPlans = () => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="p-6 w-full max-w-4xl relative z-10">
              ...
              <tr>
                ...
                <td style={tdStyle} className="text-center">
                  <Button
                    varient="outlined"
                    className="rounded-full border-customGreen px-[30px] "
                    onClick={() => handlePaln(monthlyPlanId as number)}
                  >
                    <span className="text-[#AEB7BF]">Subscribe</span>
                  </Button>
                </td>
                <td style={tdStyle} className="text-center">
                  <Button
                    varient="filled"
                    className="rounded-full bg-customGreen px-[30px] text-white"
                    onClick={() => handlePaln(yearlyPlanId as number)}
                  >
                    Subscribe
                  </Button>
                </td>
