...
const Hero = ({children}:Props) => {
  return (
    <div className=' w-[100%] bg-[#F9F4FC] h-[879.61px] relative px-[200px] z-[-1] '>
        ...
        <img src={Ellipse4} alt="" className='absolute     bottom-[-100px] right-0 ' />
        <img src={Ellipse5} alt=""   className='absolute    top-[80px] left-[10%] '/>
        <img src={Ellipse6} alt=""   className='absolute    top-[80px] left-[30%] '/>
        <img src={Ellipse7} alt=""   className='absolute    top-[80px] left-[82%] '/>
        <img src={Ellipse8} alt=""   className='absolute    top-[150px] left-[90%] '/>
        <img src={Ellipse9} alt=""   className='absolute    top-[400px] left-[92%] '/>
        <img src={Ellipse10} alt=""   className='absolute    bottom-[0]  right-32  '/>
        <img src={Ellipse11} alt=""   className='absolute    bottom-[0]  right-56 z-10'/>
        <img src={Ellipse12} alt=""   className='absolute    bottom-[300px] left-[40%] '/>
