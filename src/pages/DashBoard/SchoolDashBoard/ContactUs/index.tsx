  ...
  const faqs: Faq[] = [
    {
      ...
      a: "Kunda Kids is an award-winning educational platform that helps children learn and grow through African-inspired stories, songs, and literacy content. Our content promotes creativity, culture, and early childhood development for kids aged 2–12.",
    },
    { q: "How can I sign up?" },
        ...
        <div className="space-y-[60px]">
          ...
          <section className="grid hidden grid-cols-1 gap-[128px]  lg:grid-cols-[280px,1fr]">
            ...
            <div>
              ...
              <p className="mt-1 font-Inter font-normal mt-3 text-[14px] leading-[145%] text-[#667185]">
                Explore common questions about Kunda Kids — from signing up to
